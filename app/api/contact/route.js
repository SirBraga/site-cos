        ...
        <table role="presentation" style="width: 600px; max-width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <table role="presentation" style="width: 100%; margin-bottom: 30px;">
                <tr>
                  ...
                  <td style="padding-left: 15px; vertical-align: center;">
                    ...
                    <p style="color: #1e293b; font-size: 16px; font-weight: 500; margin: 3px 0 0;">
                      <a href="tel:${phone.replace(/\D/g, '')}" style="color: #2563eb; text-decoration: none;">${phone}</a>
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <div style="background-color: #f8fafc; border-radius: 12px; padding: 25px; border-left: 4px solid #2563eb;">
              ...
              <table role="presentation" style="width: 100%;">
                <tr>
                  <td align="center" style="padding: 0 5px;">
                    <a href="mailto:${email}" style="display: inline-block; background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 10px; font-weight: 600; font-size: 14px;">
                      Reply via Email
                    </a>
                  </td>
                  <td align="center" style="padding: 0 5px;">
          ...
          <tr>
            <td style="background-color: #1e293b; padding: 30px 40px; text-align: center;">
              <p style="color: #94a3b8; font-size: 14px; margin: 0 0 10px;">
                <strong style="color: #ffffff;">COS Cleaning & Organization Solutions</strong>
              </p>
              <p style="color: #64748b; font-size: 13px; margin: 0;">
                This email was sent from your website contact form
              </p>
              <p style="color: #475569; font-size: 12px; margin: 15px 0 0;">
                © ${new Date().getFullYear()} COS Cleaning. All rights reserved.
              </p>
            </td>
          </tr>
...
export async function POST(request) {
  try {
    ...
    // Email options
    const mailOptions = {
      from: `"Cleaning & Organization Solutions" <${process.env.GMAIL_USER}>`,
